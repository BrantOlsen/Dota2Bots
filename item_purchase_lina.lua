...
if string.match(GetBot():GetUnitName(), "hero") then
  print(GetScriptDirectory() .. "\\" .. string.gsub(GetBot():GetUnitName(), "npc_dota_hero_", "") .. "_build.lua");
   -- build = require(GetScriptDirectory() .. "\\" .. string.gsub(GetBot():GetUnitName(), "npc_dota_hero_", "") .. "_build.lua");
 --   print(build);
  --  print(build["items"]);
